<template>
  <div>
    ...
    <!-- <el-button @click="onaddStoreCityRelations">onaddStoreCityRelations</el-button>
    <el-button @click="getList">getList</el-button>
    <el-button @click="ondeleteStoreCityRelations">ondeleteStoreCityRelations</el-button>
    <el-button @click="onupdStoreCityRelations">updStoreCityRelations</el-button> -->
    <div>
      <el-table
        :data="tableData"
        style="width: 100%">

<template>
  <div class="buttons">
    ...
    <div class="block">
      ...
      <el-cascader placeholder="试试搜索：指南" v-model="city" :options="optionsCityt" filterable clearable></el-cascader>
    </div>
    <span>{{ city }}</span>
    <span>当前城市:合肥</span>
    <div></div>
    <span>{{ openweathermap.weather[0].description }}</span>
...
import { weather, getAllByCityVoList } from "@/api/sy";

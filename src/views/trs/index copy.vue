<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button v-loading="listLoading" type="primary" icon="el-icon-refresh" style="margin: 5px 8px 5px 0; background-color: #244496; float: right" @click="onrefresh()">
        全部更新
      </el-button>
      ...
      >
        <el-table-column fixed="left" label="操作" width="100">
          <template slot-scope="scope">
            <el-button type="text" size="small" icon="el-icon-refresh" @click="handleClick(scope.row)">更新</el-button>
          </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    async getList() {
      ...
      const { data, total } = await query(this.search).finally(() => {

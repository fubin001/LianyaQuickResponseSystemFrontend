  ...
  <div class="app-container">
    ...
    <div class="table-list">
      ...
      <el-table ref="dragTable" v-loading="listLoading" :data="list" row-key="id" fit
        ...
        <el-table-column prop="brandName" align="left" label="品牌名称" :width="flexColumnWidth('品牌名称', 'brandName')" />
        ...
        <el-table-column prop="boxId" align="left" label="箱号" :width="flexColumnWidth('箱号', 'boxId')" />
        <el-table-column prop="bookDate" align="left" label="订货日" :width="flexColumnWidth('商品名称', 'bookDate')" />

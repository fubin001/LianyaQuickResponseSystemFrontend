<template>
  <el-dialog title="物料单" :visible.sync="visible" :before-close="handleClose">
    <template v-if="prepare">
      <h2>基础信息</h2>
      <!--      <el-form ref="dataForm" :model="sizeForm" label-position="left" label-width="70px"-->
      ...
      >
        ...
        <el-table-column
          ...
          label="供应商物料编号"
          :min-width="flexColumnWidth(bomList, '供应商物料编号', 'supplierMaterialComponentNo')"
        />
        <el-table-column
          prop="materialDescription"
          label="物料描述"
          :min-width="flexColumnWidth(bomList, '物料描述', 'materialDescription')"
        />
        <el-table-column
          prop="componentType"
          label="组件类型"
          :min-width="flexColumnWidth(bomList, '组件类型', 'componentType')"
        />
    ...
    <template v-else>
      ...
      >
        ...
        <el-table-column
          prop="materialDescription"
          label="物料描述"
          :min-width="flexColumnWidth(useBomList, '物料描述', 'materialDescription')"
        />
        <el-table-column
          prop="componentType"
          label="组件类型"
        ...
        <el-table-column
          ...
          label="总用量"
          :min-width="flexColumnWidth(useBomList, '总量', 'totalUseQuantity')"
        >
          <template slot-scope="{row}">

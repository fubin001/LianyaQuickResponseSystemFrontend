    ...
    <div class="table-list">
      ...
      <el-table ref="dragTable" v-loading="listLoading" :data="list" row-key="id" fit highlight-current-row
        ...
        <el-table-column label="基础属性" align="center">
          <el-table-column prop="brand" label="品牌" :width="flexColumnWidth('品牌', 'brand')" />
          <el-table-column prop="styleId" align="left" label="款式" :width="flexColumnWidth('款式', 'styleId')" />
          ...
          <el-table-column prop="fullName" align="left" label="名称" :width="flexColumnWidth('名称', 'fullName')" />
        ...
        <el-table-column label="关联指标" width="90" align="center">
          <el-table-column prop="ytdSaleOutRate" align="left" label="ytd售罄率"
            :width="flexColumnWidth('预估售罄率', 'ytdSaleOutRate')">
            <template slot-scope="{ row }">
              {{ new Number(row.ytdSaleOutRate * 100).toFixed(1) }}%
            </template>
          </el-table-column>
          <el-table-column prop="firstOrderSaleOutRate" align="left" label="首单售罄率"
            :width="flexColumnWidth('预估售罄率', 'firstOrderSaleOutRate')">
            <template slot-scope="{ row }">
              {{ new Number(row.firstOrderSaleOutRate * 100).toFixed(1) }}%
            </template>
          </el-table-column>
          <el-table-column prop="predictSaleOutRate" align="left" label="预估售罄率"
            :width="flexColumnWidth('预估售罄率', 'predictSaleOutRate')">
            <template slot-scope="{ row }">
              {{ new Number(row.predictSaleOutRate * 100).toFixed(1) }}%
            </template>
          </el-table-column>
          <el-table-column prop="saleYtd" align="left" label="销售ytd" :width="flexColumnWidth('销售ytd', 'saleYtd')" />
          <el-table-column prop="storage" align="left" label="库存" :width="flexColumnWidth('库存', 'storage')" />

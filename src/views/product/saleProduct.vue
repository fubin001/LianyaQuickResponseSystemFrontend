...
<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-input v-model="listQuery.fullName" placeholder="全名称" style="width: 150px; margin: 5px 8px 5px 0" class="filter-item" />
      <el-input v-model="listQuery.skuId" placeholder="skuId" style="width: 150px; margin: 5px 8px 5px 0" class="filter-item" />
      <el-input v-model="listQuery.year" placeholder="年份" style="width: 150px; margin: 5px 8px 5px 0" class="filter-item" />
